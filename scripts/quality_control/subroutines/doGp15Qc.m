...
%   mat ::
matPaths = { ...
    [pro_output_basepath 'doQc/gp15/gp15_obs.mat'], ...
    [pro_output_basepath 'doQc/gp15/gp15_obsNoQc.mat'], ...
    [pro_output_basepath 'doQc/stations/gp15_stations.mat'] };
save(matPaths{1}, 'gp15_obs');         writeHash(matPaths{1});
save(matPaths{2}, 'gp15_obsNoQc');     writeHash(matPaths{2});
...
save(matPaths{3}, 'gp15_stations', 'NUMSTAT');  writeHash(matPaths{3});
