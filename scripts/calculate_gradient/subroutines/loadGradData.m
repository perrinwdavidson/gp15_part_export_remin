%% load data
%   gp15 observations ::
checkHash([pro_output_basepath 'interpData/observations/gp15_obs.mat']);
...
%   mld data ::
checkHash([sim_output_basepath 'calcMld/gp15_mld.mat']);
...
%   station data:
checkHash([pro_output_basepath 'doQc/stations/gp15_stations.mat']);
