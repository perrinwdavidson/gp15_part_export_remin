...
%   days in time ::
% wSpatAve = movmean(w, timeAve, 4, 'omitnan');  % bug #2: applies to raw w, silently discards the two spatial averaging passes above
wSpatAve = movmean(wSpatAve, timeAve, 4, 'omitnan');
