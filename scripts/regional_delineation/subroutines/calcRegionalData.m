...
for istat = 1 : 1 : NUMSTAT
	...
	% bug: flag==2 check used po4.flag instead of no3.flag; corrected below ::
	...
	no3 = delineate_data_raw.no3.data((int64(delineate_data_raw.no3.stationNo) == stat) & ...
					  ...
					  ((delineate_data_raw.no3.flag == 1) | (delineate_data_raw.no3.flag == 2)) & ...
...
%   save ::
exportgraphics(delineate_plot, [plot_output_basepath 'delineateRegions/regionalMetrics.pdf'], 'ContentType', 'vector');
