...
t100_data = vcat(gp15_data[:, end-4], epzt_data[:, 7], global_data[:, 8])
...
group_color = [MarkerElement(marker = :circle, color = allcolors[1], strokecolor = :black, strokewidth = 2, markersize = 20),
               ...
               MarkerElement(marker = :circle, color = allcolors[6], strokecolor = :black, strokewidth = 0.5, markersize = 20)]
...
save("plots/gp15Model/supporting_information/fig_global_metrics.pdf", fig₉)
