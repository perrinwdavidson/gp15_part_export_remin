...
station_colors = Dict("port" => :black,  # ColorSchemes.RdBu_9[1], # Makie.wong_colors()[3], 
                      ...
                      "demi" => ColorSchemes.RdGy_3[3],  # :white, 
                      "full" => ColorSchemes.RdBu_9[9],  # Makie.wong_colors()[1], 
                      "super" => ColorSchemes.RdGy_3[2],  # Makie.wong_colors()[6], 
...
demi = MarkerElement(color = ColorSchemes.RdGy_3[3], marker = :circle, markersize = 10/δ, strokecolor = :black, strokewidth = 1)
full = MarkerElement(color = ColorSchemes.RdBu_9[9], marker = :circle, markersize = 20/δ, strokecolor = :black, strokewidth = 1)
super = MarkerElement(color = ColorSchemes.RdGy_3[2], marker = :circle, markersize = 20/δ, strokecolor = :black, strokewidth = 1)
...
xlims!(ax₁, -180, -120)
ylims!(ax₁, -22, 62)
save("plots/gp15Model/manuscript/fig1.pdf", fig₁)
