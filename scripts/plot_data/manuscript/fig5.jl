...
colors = ColorSchemes.GnBu_9[grp]
colors[1:length(lat)] .= ColorSchemes.RdGy_3[2]
...
barplot!(ax₆, lat, dat, stack = grp, color = colors, gap = 0.5, strokecolor = :black, strokewidth = 1)

labels = ["Micro", "Pico", "Nano"]
elements = [PolyElement(polycolor = c, strokecolor = :black, strokewidth = 1) for c in [ColorSchemes.RdGy_3[2], ColorSchemes.GnBu_9[5], ColorSchemes.GnBu_9[9]]]
...
save("plots/gp15Model/manuscript/fig5.pdf", fig₅)
