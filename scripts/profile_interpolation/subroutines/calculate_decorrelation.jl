...
# ---------------------------------------------------------
# load data ::
ecco_wₒ = NCDataset("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_pacific.nc")
wₒ = ecco_wₒ["pacific_wo"][:, :]

# select data ::
idx = sort(randsubseq(collect(1 : 1 : size(wₒ)[1]), 0.005))
coords = wₒ[idx, 1:3]
data = wₒ[idx, 5]  # 4 is raw, 5 is detrended

# make bins (Sumata (2017, Ocean Sci.)) ::
bin_space = (0 : 10 : 5E2) .* 1000  # [m]
bin_time = (0 : 35 : 4E2) .* (60 * 60 * 24)  # [s]
...
# calculate autocorrelation ::
time_autocorr_init = nanmean(autocorr, dims = 1)
time_autocorr = nanmean(autocorr, dims = 1)
space_autocorr = nanmean(autocorr, dims = 2)
...
time_autocorr[bt_plot .> 200] .= NaN  # see pg. 172 from Sumata (2017, Ocean Sci.)
...
save("plots/interpData/decorrelation/autocorrelation.png", f, px_per_unit = 4)
...
lines!(ax₆, bt_plot_init, fitted_data_time, color = "red", linestyle = "--")
...
lines!(ax₇, bs_plot, fitted_data_space, color = "red", linestyle = "--", label = L"$$Fit") 
axislegend()

save("plots/interpData/decorrelation/autocorrelation_mean.png", f, px_per_unit = 4)
...
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_autocorr.jld2", autocorr)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_autocov.jld2", autocov)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_autovar1.jld2", autovar₁)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_autovar2.jld2", autovar₂)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_counts.jld2", counts)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_time_bins_array.jld2", time_bins_array)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_spatial_bins_array.jld2", spatial_bins_array)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_time_autocorr_mean.jld2", time_autocorr_mean)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_spatial_autocorr_mean.jld2", spatial_autocorr_mean)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_spatial_autocorr_mean_fit.jld2", fitted_data_space)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_spatial_autocorr_mean_fit_params.jld2", fit_params_space)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_spatial_autocorr_mean_fit_params_err.jld2", fit_params_err_space)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_temporal_autocorr_mean_fit.jld2", fitted_data_time)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_temporal_autocorr_mean_fit_params.jld2", fit_params_time)
save_object("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/ecco_temporal_autocorr_mean_fit_params_err.jld2", fit_params_err_time)

# write out length scales ::
writedlm("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/spatial_decorrelation.csv", 
         hcat(fit_params_space, fit_params_err_space), 
         ',')
writedlm("/Users/perrindavidson/research/whoi/current/gp15/data/sim/interpData/decorrelation/temporal_decorrelation.csv", 
